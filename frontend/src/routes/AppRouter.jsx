...
import PatientWizard from '@/pages/patients/PatientWizard.jsx';
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<DashboardLayout />}>
            ...
            <Route path={ROUTES.PATIENT_NEW} element={<PatientWizard />} />
            <Route path={ROUTES.PATIENT_DETAIL} element={<PatientDetail />} />
            <Route path={ROUTES.PATIENT_EDIT} element={<PatientWizard />} />
